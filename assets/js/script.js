...
document.querySelector('.video-image-wrapper').addEventListener('click', function() {
  // Replace 'YOUR_YOUTUBE_VIDEO_ID' with actual YouTube video ID
  ...
  document.querySelector('.video-popup-overlay').onclick = function() {
      document.querySelector('.video-popup').remove();
  };
});
